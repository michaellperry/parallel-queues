...
public static class ShippingMetrics
{
    ...
    private static readonly Histogram WaitTimeHistogram = Metrics
        .CreateHistogram("shipping_wait_time_seconds", "Tracks the total time in system (W) in seconds", new HistogramConfiguration
        {
    ...
    private static readonly Histogram ProcessingTimeHistogram = Metrics
        .CreateHistogram("shipping_processing_time_seconds", "Tracks the processing time (τ) in seconds", new HistogramConfiguration
        {
            // Define buckets for the histogram
    ...
    private static readonly Counter ProcessedCounter = Metrics
        .CreateCounter("shipping_processed_total", "Counts the total number of processed orders");
